          ...
          <div className="text-center mb-6 md:mb-8">
            ...
            {uploadDateTime && (
              <div className="mt-3 md:mt-4 flex flex-col items-center justify-center gap-3">
                ...
                <div className="flex items-center justify-center gap-2 md:gap-3 flex-wrap px-2">
                  ...
                  {gistId && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 md:gap-2 bg-green-600 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-medium hover:bg-green-700 transition-colors"
                ...
                {/* Fila 2: Botones de Acción (Movidos desde abajo) */}
                {results && !loading && !showAulasManager && (
                  <div className="flex items-center justify-center gap-2 md:gap-3 flex-wrap">
                    <label className="flex items-center justify-center gap-1.5 md:gap-2 px-3 md:px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors cursor-pointer text-xs md:text-sm font-medium">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 md:gap-2 px-3 md:px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-xs md:text-sm font-medium"
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-1.5 md:gap-2 px-3 md:px-4 py-2 rounded-lg transition-all text-xs md:text-sm font-medium ${showStats
            ...
            <div>
              ...
              {showStats && stats && (
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-4 mb-4 md:mb-6">
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 md:p-4 col-span-2 md:col-span-1">
